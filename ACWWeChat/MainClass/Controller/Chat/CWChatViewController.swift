...
class CWChatViewController: CWBaseMessageViewController {
    ...
    func registerCell() {
        ...
        tableView.register(CWBaseMessageCell.self, forCellReuseIdentifier: CWChatMessageType.none.reuseIdentifier())
        tableView.register(CWTextMessageCell.self, forCellReuseIdentifier: CWChatMessageType.text.reuseIdentifier())
        tableView.register(CWImageMessageCell.self, forCellReuseIdentifier: CWChatMessageType.image.reuseIdentifier())
        tableView.register(CWVoiceMessageCell.self, forCellReuseIdentifier: CWChatMessageType.voice.reuseIdentifier())
        tableView.register(CWTimeMessageCell.self, forCellReuseIdentifier: CWChatMessageType.time.reuseIdentifier())
